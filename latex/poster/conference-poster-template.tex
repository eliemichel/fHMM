...
{\includegraphics[scale=0.3]{../resources/pictures/logos/logo-ens_paris_saclay.jpg} % University/lab logo
}
%----------------------------------------------------------------------------------------
%	INTRODUCTION
%----------------------------------------------------------------------------------------
...
\bibliography{../resources/bibliography/bibfile} % Use sample.bib as the bibliography file
}
